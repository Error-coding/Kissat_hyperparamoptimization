...
scenario = Scenario(get_kissat2024_confspace(), deterministic=True, n_trials=ntrials, output_directory = "/nfs/home/rzipperer/git/Kissat_hyperparamoptimization/outputs/toplevel/liskov/" + str(instancegroup))
