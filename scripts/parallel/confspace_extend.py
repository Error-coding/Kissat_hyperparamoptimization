...
def decision_options():
    ...
    bumpreasonslimit = Integer("bumpreasonslimit", (1, 1000), default=10)
    bumpreasonsrate = Integer("bumpreasonsrate", (1, 1000), default=10)
    ...
    randeclength = Integer("randeclength", (1, 1000), default=10)
...
def pre_and_inprocessing_options():
    ...
    backbonemaxrounds = Integer("backbonemaxrounds", (1, 50000), default=1000)
    backbonerounds = Integer("backbonerounds", (1, 10000), default=100)
    ...
    sweepclauses = Integer("sweepclauses", (0, 65536), default=1024)
    sweepcomplete = Integer("sweepcomplete", (0, 1), default=0)
    sweepdepth = Integer("sweepdepth", (0, 2147483647), default=2)
    sweepfliprounds = Integer("sweepfliprounds", (0, 20), default=1)
    sweepmaxclauses = Integer("sweepmaxclauses", (2, 150000), default=32768)
    sweepmaxdepth = Integer("sweepmaxdepth", (1, 20), default=3)
    sweepmaxvars = Integer("sweepmaxvars", (2, 50000), default=8192)
    sweeprand = Integer("sweeprand", (0, 1), default=0)
    sweepvars = Integer("sweepvars", (0, 4096), default=256)
    ...
    eliminateclslim = Integer("eliminateclslim", (1, 1000), default=100)
    eliminateinit = Integer("eliminateinit", (0, 5000), default=500)
    eliminateocclim = Integer("eliminateocclim", (0, 10000), default=2000)
